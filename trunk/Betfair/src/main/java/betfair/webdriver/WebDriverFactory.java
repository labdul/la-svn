...
public class WebDriverFactory {
	...
	public static WebDriver getInstance(String gridHubUrl, Browser browser,
		...
		if (CHROME.equals(browserName)) {
			...
			File file = new File("C:\\Users\\labdulsa.OPENBET\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles\\asepuwi7.default"); 			
			FirefoxProfile ffProfile = new FirefoxProfile(file);
