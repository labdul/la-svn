...
public class PromotionalCodeTest extends TestBase{
	...
	public void registration() throws Exception {
		...
		cmAddOffer.offerName("promoCode");
		...
		cmAddTrigger.typeTrigger("Promotional Code Trigger");
	    ...
	    cmAddReward.insertCurrency("AUD", "15.00");
	    cmAddReward.insertCurrency("CAD", "15.00");
	    cmAddReward.insertCurrency("DKK", "15.00");
	    cmAddReward.insertCurrency("EUR", "15.00");
	    cmAddReward.insertCurrency("GBP", "15.00");
	    cmAddReward.insertCurrency("HKD", "15.00");
	    cmAddReward.insertCurrency("NOK", "15.00");
	    cmAddReward.insertCurrency("SEK", "15.00");
	    cmAddReward.insertCurrency("SGD", "15.00");
	    cmAddReward.insertCurrency("USD", "15.00");
		...
		int sizeOfCustomer = oxiLatest.call("reqAcctGetFFreebets").withParams("user:Administrator,pass:1ncharge,ssoid:"+ssoid).withMultipleReturn("oxip.response.respAccountGetFreebets.freebetToken.freebetTokenId[*]").size() -1;
		String reqAcctGetFFreebets = oxiLatest.call("reqAcctGetFFreebets").withParams("user:Administrator,pass:1ncharge,ssoid:"+ssoid).withSingleReturn("oxip.response.respAccountGetFreebets.freebetToken.freebetTokenId[" + sizeOfCustomer + "]");
